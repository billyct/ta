...
/* cny15/my-sell-orders.html */
class __TwigTemplate_56e0c9218c5d2ffaad41a05a6f9f410f extends Twig_Template
{
...
\t                        \t\t\t\t<a href=\"";
            ...
            echo "/cny15/manage/my_sell_order/";
            if (isset($context["order"])) { $_order_ = $context["order"]; } else { $_order_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_order_, "id"), "html", null, true);
            echo "\">查看订单详情</a>
\t                        \t\t\t</td>
...
";
    ...
    {
        return "cny15/my-sell-orders.html";
    }
